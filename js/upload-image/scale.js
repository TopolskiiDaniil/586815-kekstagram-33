...
function onScaleChangeButtonClick(thisButton, otherButton, maxOrMinScaleValue, step) {
  return function () {
...
increaseScaleButtonNode.addEventListener('click', onScaleChangeButtonClick(increaseScaleButtonNode, decreaseScaleButtonNode, MAX_SCALE_VALUE, SCALE_STEP));

decreaseScaleButtonNode.addEventListener('click', onScaleChangeButtonClick(decreaseScaleButtonNode, increaseScaleButtonNode, MIN_SCALE_VALUE, -SCALE_STEP));
